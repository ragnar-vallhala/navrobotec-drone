\section{PCB Design and Fabrication}
...
The PCB was designed using KiCad, an open-source electronics design automation (EDA) suite. Figure~\ref{fig:kicad_pcb} shows the 3D representation of the board design, highlighting the integration of the STM32F4 microcontroller, sensor interfaces, communication ports, and power management circuitry.

\begin{figure}[H]
    \centering
    \begin{minipage}{0.44\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/kicad.png}
        \caption{3D visualization of the Vayu PCB design in KiCad.}
        \label{fig:kicad_pcb}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/trace_pcb.png}
        \caption{Detailed trace layout and routing of the Vayu flight controller PCB.}
        \label{fig:trace_pcb_side}
    \end{minipage}
\end{figure}
...
Figure~\ref{fig:real_pcb} shows the assembled hardware.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{img/real_pcb.jpeg}
    \caption{The fabricated and assembled Vayu flight control board.}
    \label{fig:real_pcb}
\end{figure}
